    ...
    return(
        <SafeAreaView className="pt-[38px] px-5 bg-white flex-1">
            ...
            render={({ field: { value, onChange } }) => (
                <TextInput placeholder="E-mail" value={value} onChangeText={onChange} className="bg-bondis-text-gray rounded-[4px] h-[52px] mt-2 pl-4"/>  
            )}
            />
            ...
            name="password"
            render={({ field: { value, onChange } }) => (
                <TextInput placeholder="Senha" onChangeText={onChange} value={value} className="bg-bondis-text-gray rounded-[4px] h-[52px] mt-2 pl-4"/>  
            )}
            /> 
            ...
            <TouchableOpacity onPress={handleSubmit(onSubmit)} className="h-[52px] bg-bondis-green mt-8 rounded-full justify-center items-center">
